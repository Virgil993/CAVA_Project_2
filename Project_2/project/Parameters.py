...
class Parameters:
    def __init__(self):
        self.base_dir = 'G:\GitHub Repositories\CAVA_Project_2_2\Project_2\data'
        ...
        self.path_annotations = os.path.join(self.base_dir, 'exempleTest\Validare_adnotari\\task1_gt_validare.txt')
        ...
        self.dir_save_solutions = "G:\GitHub Repositories\CAVA_Project_2_2\Project_2\evaluare\\fisiere_solutie\\333_Virgil_Turcu"
        # directorul in care vor fi salvate soluttile sub format npy pentru task-ul 1
        self.dir_save_solutions_task1 = os.path.join(self.dir_save_solutions,"task1")

        # set the parameters
        self.dim_window = 72  # exemplele pozitive (fete de oameni cropate) au 72x72 pixeli
